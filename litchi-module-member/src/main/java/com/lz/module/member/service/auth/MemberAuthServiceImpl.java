package com.lz.module.member.service.auth;

import cn.hutool.core.lang.Assert;
import com.lz.framework.common.enums.CommonStatusEnum;
import com.lz.framework.common.enums.TerminalEnum;
...
import com.lz.module.member.controller.app.auth.vo.*;
import com.lz.module.member.convert.auth.AuthConvert;
import com.lz.module.member.dal.dataobject.user.MemberUserDO;
import com.lz.module.member.service.user.MemberUserService;
import com.lz.module.system.api.logger.LoginLogApi;
import com.lz.module.system.api.logger.dto.LoginLogCreateReqDTO;
import com.lz.framework.common.biz.system.oauth2.OAuth2TokenCommonApi;
import com.lz.framework.common.biz.system.oauth2.dto.OAuth2AccessTokenCreateReqDTO;
import com.lz.framework.common.biz.system.oauth2.dto.OAuth2AccessTokenRespDTO;
import com.lz.module.system.api.sms.SmsCodeApi;
import com.lz.module.system.api.social.SocialClientApi;
import com.lz.module.system.api.social.SocialUserApi;
...
import com.lz.module.system.api.social.dto.SocialWxPhoneNumberInfoRespDTO;
import com.lz.module.system.enums.logger.LoginLogTypeEnum;
...
import static com.lz.module.member.enums.ErrorCodeConstants.*;
...
public class MemberAuthServiceImpl implements MemberAuthService {
    ...
    public void sendSmsCode(Long userId, AppAuthSmsSendReqVO reqVO) {
        ...
        if (Objects.equals(reqVO.getScene(), SmsSceneEnum.MEMBER_UPDATE_PASSWORD.getScene())) {
            ...
            // TODO YY：后续 member user 手机非强绑定，这块需要做下调整；
