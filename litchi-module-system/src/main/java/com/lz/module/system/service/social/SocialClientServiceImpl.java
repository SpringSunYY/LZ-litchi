package com.lz.module.system.service.social;
...
import com.lz.module.system.api.social.dto.SocialWxQrcodeReqDTO;
...
import com.lz.module.system.dal.mysql.social.SocialClientMapper;
import com.lz.module.system.dal.redis.RedisKeyConstants;
import com.lz.module.system.enums.social.SocialTypeEnum;
import com.lz.module.system.framework.justauth.core.AuthRequestFactory;
...
import static com.lz.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static com.lz.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${litchi.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${litchi.wxa-subscribe-message.miniprogram-state:formal}")
