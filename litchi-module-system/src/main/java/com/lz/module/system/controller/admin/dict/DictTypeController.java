package com.lz.module.system.controller.admin.dict;
...
import com.lz.module.system.controller.admin.dict.vo.type.DictTypeRespVO;
import com.lz.module.system.controller.admin.dict.vo.type.DictTypeSaveReqVO;
import com.lz.module.system.controller.admin.dict.vo.type.DictTypeSimpleRespVO;
import com.lz.module.system.dal.dataobject.dict.DictTypeDO;
import com.lz.module.system.service.dict.DictTypeService;
...
public class DictTypeController {
    ...
    public CommonResult<Boolean> deleteDictType(@RequestParam("id") Long id,
        ...
        dictTypeService.deleteDictType(id, isDeleteChildren);
        return success(true);
    }
