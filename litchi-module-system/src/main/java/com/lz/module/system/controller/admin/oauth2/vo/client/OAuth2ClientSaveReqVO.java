package com.lz.module.system.controller.admin.oauth2.vo.client;
...
public class OAuth2ClientSaveReqVO {
    ...
    @I18nNotNull(i18nKey = "system.oauth2Client.back.clientId.notNull", message = "客户端编号不能为空")
    private String clientId;

    @Schema(description = "客户端密钥", requiredMode = Schema.RequiredMode.REQUIRED, example = "fan")
    @I18nNotNull(i18nKey = "system.oauth2Client.back.secret.notNull", message = "客户端密钥不能为空")
    private String secret;

    @Schema(description = "应用名", requiredMode = Schema.RequiredMode.REQUIRED, example = "土豆")
    @I18nNotNull(i18nKey = "system.oauth2Client.back.name.notNull", message = "应用名不能为空")
    private String name;
    ...
    @I18nNotNull(i18nKey = "system.oauth2Client.back.status.notNull", message = "状态不能为空")
    private Integer status;

    @Schema(description = "访问令牌的有效期", requiredMode = Schema.RequiredMode.REQUIRED, example = "8640")
    @I18nNotNull(i18nKey = "system.oauth2Client.back.accessTokenValiditySeconds.notNull", message = "访问令牌的有效期不能为空")
    private Integer accessTokenValiditySeconds;

    @Schema(description = "刷新令牌的有效期", requiredMode = Schema.RequiredMode.REQUIRED, example = "8640000")
    @I18nNotNull(i18nKey = "system.oauth2Client.back.refreshTokenValiditySeconds.notNull", message = "刷新令牌的有效期不能为空")
    private Integer refreshTokenValiditySeconds;

    @Schema(description = "可重定向的 URI 地址", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.iocoder.cn")
    @I18nNotNull(i18nKey = "system.oauth2Client.back.redirectUris.notNull", message = "可重定向的 URI 地址不能为空")
    private List<@I18nNotEmpty(i18nKey = "system.oauth2Client.back.redirectUris.notEmpty", message = "重定向的 URI 不能为空") @I18nURL(i18nKey = "system.oauth2Client.back.redirectUris.url", message = "重定向的 URI 格式不正确") String> redirectUris;

    @Schema(description = "授权类型，参见 OAuth2GrantTypeEnum 枚举", requiredMode = Schema.RequiredMode.REQUIRED, example = "password")
    @I18nNotNull(i18nKey = "system.oauth2Client.back.authorizedGrantTypes.notNull", message = "授权类型不能为空")
    ...
    @I18nAssertTrue(i18nKey = "system.oauth2Client.back.additionalInformation.assertTrue", message = "附加信息必须是 JSON 格式")
