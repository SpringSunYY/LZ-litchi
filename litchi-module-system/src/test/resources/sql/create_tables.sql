...
-- 租户套餐订阅表
CREATE TABLE IF NOT EXISTS "system_tenant_package_subscribe" (
    "id" bigint NOT NULL GENERATED BY DEFAULT AS IDENTITY,
    "package_name" varchar(255) NOT NULL COMMENT '套餐名',
    "package_code" varchar(63) NOT NULL COMMENT '套餐编码',
    "package_type" int NOT NULL COMMENT '套餐类型',
    "package_status" int NOT NULL COMMENT '套餐状态',
    "package_logo" varchar(255) COMMENT 'LOGO',
    "tenant_name" varchar(255) NOT NULL COMMENT '租户名',
    "tenant_code" varchar(63) NOT NULL COMMENT '租户编码',
    "price" decimal(10, 2) COMMENT '套餐价格',
    "discount_price" decimal(10, 2) COMMENT '优惠价格',
    "days" int COMMENT '天数',
    "total_price" decimal(10, 2) COMMENT '总价格',
    "status" int NOT NULL COMMENT '订阅状态',
