package com.lz.module.pay.controller.admin.transfer.vo;

import com.lz.framework.excel.core.annotations.DictFormat;
import com.lz.framework.excel.core.convert.DictConvert;
import com.lz.framework.excel.core.convert.MoneyConvert;
...
public class PayTransferRespVO {
    ...
    @ExcelProperty("应用名称")
    @Schema(description = "应用名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "YY")
