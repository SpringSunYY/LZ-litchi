package com.lz.module.pay.framework.pay.core.client.impl.wallet;

import cn.hutool.core.lang.Assert;
import cn.hutool.core.map.MapUtil;
import cn.hutool.extra.spring.SpringUtil;
import com.lz.framework.common.exception.ServiceException;
import com.lz.module.pay.enums.PayChannelEnum;
import com.lz.module.pay.enums.refund.PayRefundStatusEnum;
import com.lz.module.pay.enums.transfer.PayTransferStatusEnum;
import com.lz.module.pay.framework.pay.core.client.dto.order.PayOrderRespDTO;
import com.lz.module.pay.framework.pay.core.client.dto.order.PayOrderUnifiedReqDTO;
import com.lz.module.pay.framework.pay.core.client.dto.refund.PayRefundRespDTO;
import com.lz.module.pay.framework.pay.core.client.dto.refund.PayRefundUnifiedReqDTO;
import com.lz.module.pay.framework.pay.core.client.dto.transfer.PayTransferRespDTO;
import com.lz.module.pay.framework.pay.core.client.dto.transfer.PayTransferUnifiedReqDTO;
import com.lz.module.pay.framework.pay.core.client.impl.AbstractPayClient;
import com.lz.module.pay.framework.pay.core.client.impl.NonePayClientConfig;
import com.lz.module.pay.dal.dataobject.order.PayOrderExtensionDO;
import com.lz.module.pay.dal.dataobject.refund.PayRefundDO;
import com.lz.module.pay.dal.dataobject.transfer.PayTransferDO;
...
import com.lz.module.pay.enums.wallet.PayWalletBizTypeEnum;
import com.lz.module.pay.service.order.PayOrderService;
import com.lz.module.pay.service.refund.PayRefundService;
import com.lz.module.pay.service.transfer.PayTransferService;
import com.lz.module.pay.service.wallet.PayWalletService;
import com.lz.module.pay.service.wallet.PayWalletTransactionService;
import lombok.extern.slf4j.Slf4j;

import java.util.Map;

import static com.lz.framework.common.exception.enums.GlobalErrorCodeConstants.INTERNAL_SERVER_ERROR;
import static com.lz.module.pay.enums.ErrorCodeConstants.PAY_ORDER_EXTENSION_NOT_FOUND;
import static com.lz.module.pay.enums.ErrorCodeConstants.REFUND_NOT_FOUND;
