package com.lz.module.pay.service.wallet;
...
import com.lz.module.pay.controller.app.wallet.vo.recharge.AppPayWalletRechargeCreateReqVO;
import com.lz.module.pay.dal.dataobject.order.PayOrderDO;
import com.lz.module.pay.dal.dataobject.wallet.PayWalletDO;
import com.lz.module.pay.dal.dataobject.wallet.PayWalletRechargeDO;
import com.lz.module.pay.dal.dataobject.wallet.PayWalletRechargePackageDO;
import com.lz.module.pay.dal.mysql.wallet.PayWalletRechargeMapper;
...
import com.lz.module.system.api.social.dto.SocialWxaOrderUploadShippingInfoReqDTO;
...
import static com.lz.framework.common.util.number.MoneyUtils.fenToYuanStr;
import static com.lz.module.pay.convert.wallet.PayWalletRechargeConvert.INSTANCE;
import static com.lz.module.pay.enums.ErrorCodeConstants.*;
import static com.lz.module.pay.enums.MessageTemplateConstants.WXA_WALLET_RECHARGER_PAID;
import static com.lz.module.pay.enums.refund.PayRefundStatusEnum.*;
...
//    private PayRefundService payRefundService;
    ...
    public PayWalletRechargeDO createWalletRecharge(Long userId, Integer userType, String userIp,
        ...
        Long payOrderId = payOrderService.createOrder(new PayOrderCreateReqDTO()
                ...
                .setExpireTime(addTime(Duration.ofHours(2L)))); // TODO @YY：支付超时时间
        // 2.2 更新钱包充值记录中支付订单
