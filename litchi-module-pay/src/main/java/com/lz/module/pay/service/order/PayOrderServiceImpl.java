package com.lz.module.pay.service.order;
...
import com.lz.module.pay.framework.pay.core.client.PayClient;
...
import com.lz.module.pay.controller.admin.order.vo.PayOrderExportReqVO;
import com.lz.module.pay.controller.admin.order.vo.PayOrderPageReqVO;
import com.lz.module.pay.controller.admin.order.vo.PayOrderSubmitReqVO;
import com.lz.module.pay.controller.admin.order.vo.PayOrderSubmitRespVO;
import com.lz.module.pay.convert.order.PayOrderConvert;
import com.lz.module.pay.dal.dataobject.app.PayAppDO;
import com.lz.module.pay.dal.dataobject.channel.PayChannelDO;
import com.lz.module.pay.dal.dataobject.order.PayOrderDO;
import com.lz.module.pay.dal.dataobject.order.PayOrderExtensionDO;
import com.lz.module.pay.dal.mysql.order.PayOrderExtensionMapper;
import com.lz.module.pay.dal.mysql.order.PayOrderMapper;
import com.lz.module.pay.dal.redis.no.PayNoRedisDAO;
import com.lz.module.pay.enums.notify.PayNotifyTypeEnum;
import com.lz.module.pay.enums.order.PayOrderStatusEnum;
import com.lz.module.pay.framework.pay.config.PayProperties;
import com.lz.module.pay.service.app.PayAppService;
import com.lz.module.pay.service.channel.PayChannelService;
...
import static com.lz.module.pay.enums.ErrorCodeConstants.*;
    ...
    public PayOrderSubmitRespVO submitOrder(PayOrderSubmitReqVO reqVO, String userIp) {
        ...
        if (unifiedOrderResp != null) {
            try {
                ...
                // 兼容 https://gitee.com/zhijiantianya/litchi-cloud/issues/I8SM9H 场景
