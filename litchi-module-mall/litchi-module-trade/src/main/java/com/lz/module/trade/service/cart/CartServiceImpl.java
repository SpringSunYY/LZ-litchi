package com.lz.module.trade.service.cart;
...
import com.lz.module.trade.controller.app.cart.vo.*;
import com.lz.module.trade.convert.cart.TradeCartConvert;
import com.lz.module.trade.dal.dataobject.cart.CartDO;
import com.lz.module.trade.dal.mysql.cart.CartMapper;
...
import static com.lz.module.trade.enums.ErrorCodeConstants.CARD_ITEM_NOT_FOUND;
import static java.util.Collections.emptyList;

/**
 * 购物车 Service 实现类
 *
 * // TODO YY：未来优化：购物车的价格计算，支持营销信息；目前不支持的原因，前端界面需要前端 pr 支持下；例如说：会员价格；
 *
 * @author 荔枝源码
 */
@Service
