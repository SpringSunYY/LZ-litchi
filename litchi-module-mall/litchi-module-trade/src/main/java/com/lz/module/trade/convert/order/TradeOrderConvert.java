...
import com.lz.module.member.api.user.dto.MemberUserRespDTO;
import com.lz.module.pay.api.order.dto.PayOrderCreateReqDTO;
import com.lz.module.pay.enums.DictTypeConstants;
import com.lz.module.product.api.comment.dto.ProductCommentCreateReqDTO;
import com.lz.module.product.api.property.dto.ProductPropertyValueDetailRespDTO;
import com.lz.module.product.api.sku.dto.ProductSkuRespDTO;
import com.lz.module.product.api.sku.dto.ProductSkuUpdateStockReqDTO;
import com.lz.module.product.api.spu.dto.ProductSpuRespDTO;
import com.lz.module.promotion.api.combination.dto.CombinationRecordCreateReqDTO;
import com.lz.module.trade.api.order.dto.TradeOrderRespDTO;
import com.lz.module.trade.controller.admin.base.member.user.MemberUserRespVO;
import com.lz.module.trade.controller.admin.base.product.property.ProductPropertyValueDetailRespVO;
import com.lz.module.trade.controller.admin.order.vo.*;
import com.lz.module.trade.controller.app.base.property.AppProductPropertyValueDetailRespVO;
import com.lz.module.trade.controller.app.order.vo.*;
import com.lz.module.trade.controller.app.order.vo.item.AppTradeOrderItemCommentCreateReqVO;
import com.lz.module.trade.controller.app.order.vo.item.AppTradeOrderItemRespVO;
...
import com.lz.module.trade.framework.delivery.core.client.dto.ExpressTrackRespDTO;
import com.lz.module.trade.framework.order.config.TradeOrderProperties;
import com.lz.module.trade.service.brokerage.bo.BrokerageAddReqBO;
...
import static com.lz.framework.common.util.collection.CollectionUtils.convertMultiMap;
import static com.lz.framework.common.util.date.LocalDateTimeUtils.addTime;
...
public interface TradeOrderConvert {
    ...
    default PayOrderCreateReqDTO convert(TradeOrderDO order, List<TradeOrderItemDO> orderItems,
        ...
        createReqDTO.setBody(subject); // TODO YY：临时写死
        // 订单相关字段
