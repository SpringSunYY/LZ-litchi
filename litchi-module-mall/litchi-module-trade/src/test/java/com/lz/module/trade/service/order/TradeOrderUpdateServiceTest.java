...
import com.lz.module.member.api.user.MemberUserApi;
...
import com.lz.module.product.api.sku.ProductSkuApi;
import com.lz.module.product.api.spu.ProductSpuApi;
import com.lz.module.promotion.api.coupon.CouponApi;
import com.lz.module.system.api.notify.NotifyMessageSendApi;
import com.lz.module.trade.controller.admin.delivery.vo.express.DeliveryExpressCreateReqVO;
...
import com.lz.module.trade.enums.order.TradeOrderRefundStatusEnum;
import com.lz.module.trade.enums.order.TradeOrderStatusEnum;
import com.lz.module.trade.framework.order.config.TradeOrderConfig;
import com.lz.module.trade.framework.order.config.TradeOrderProperties;
import com.lz.module.trade.service.cart.CartServiceImpl;
import com.lz.module.trade.service.delivery.DeliveryExpressService;
import com.lz.module.trade.service.delivery.DeliveryExpressServiceImpl;
import com.lz.module.trade.service.message.TradeMessageServiceImpl;
import com.lz.module.trade.service.order.handler.TradeOrderHandler;
import com.lz.module.trade.service.price.TradePriceServiceImpl;
import com.lz.module.trade.service.price.calculator.TradePriceCalculator;
...
import static com.lz.framework.test.core.util.RandomUtils.randomPojo;
...
//        // mock 方法（用户收件地址的校验）
//        MemberAddressRespDTO addressRespDTO = new MemberAddressRespDTO().setId(10L).setUserId(userId).setName("YY")
...
//        assertEquals(tradeOrderDO.getReceiverName(), "YY");
