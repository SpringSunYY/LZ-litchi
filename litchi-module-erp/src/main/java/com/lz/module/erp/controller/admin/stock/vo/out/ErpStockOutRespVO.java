package com.lz.module.erp.controller.admin.stock.vo.out;
...
import static com.lz.module.erp.enums.DictTypeConstants.AUDIT_STATUS;
...
public class ErpStockOutRespVO {
    ...
    @ExcelProperty("出库编号")
    @ExcelI18n(i18nKey = "erp.stockOut.field.id")
    private Long id;

    @Schema(description = "出库单号", requiredMode = Schema.RequiredMode.REQUIRED, example = "S123")
    @ExcelProperty("出库单号")
    @ExcelI18n(i18nKey = "erp.stockOut.field.no")
    private String no;
    ...
    @ExcelProperty("创建时间")
    @ExcelI18n(i18nKey = "erp.stockOut.field.createTime")
    ...
    @ExcelProperty("产品信息")
    @ExcelI18n(i18nKey = "erp.stockOut.field.productNames")
