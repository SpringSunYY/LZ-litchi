...
import com.lz.module.erp.dal.mysql.stock.ErpStockMapper;
...
import static com.lz.module.erp.enums.ErrorCodeConstants.STOCK_COUNT_NEGATIVE;
import static com.lz.module.erp.enums.ErrorCodeConstants.STOCK_COUNT_NEGATIVE2;
...
public class ErpStockServiceImpl implements ErpStockService {
    ...
    public BigDecimal getStockCount(Long productId, Long warehouseId) {
        BigDecimal count = stockMapper.selectSumByProductId(productId, warehouseId);
