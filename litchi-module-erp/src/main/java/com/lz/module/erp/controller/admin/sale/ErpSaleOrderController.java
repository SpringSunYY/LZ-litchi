package com.lz.module.erp.controller.admin.sale;
...
import com.lz.module.erp.controller.admin.sale.vo.order.ErpSaleOrderPageReqVO;
import com.lz.module.erp.controller.admin.sale.vo.order.ErpSaleOrderRespVO;
import com.lz.module.erp.controller.admin.sale.vo.order.ErpSaleOrderSaveReqVO;
import com.lz.module.erp.dal.dataobject.sale.ErpCustomerDO;
import com.lz.module.erp.dal.dataobject.sale.ErpSaleOrderDO;
import com.lz.module.erp.dal.dataobject.sale.ErpSaleOrderItemDO;
import com.lz.module.erp.service.product.ErpProductService;
import com.lz.module.erp.service.sale.ErpCustomerService;
import com.lz.module.erp.service.sale.ErpSaleOrderService;
    ...
    public CommonResult<ErpSaleOrderRespVO> getSaleOrder(@RequestParam("id") Long id) {
        ...
        return success(BeanUtils.toBean(saleOrder, ErpSaleOrderRespVO.class, saleOrderVO ->
                saleOrderVO.setItems(BeanUtils.toBean(saleOrderItemList, ErpSaleOrderRespVO.Item.class, item -> {
                    BigDecimal stockCount = stockService.getStockCount(item.getProductId(), null);
