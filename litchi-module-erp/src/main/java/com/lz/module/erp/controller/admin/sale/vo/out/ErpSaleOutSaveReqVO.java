package com.lz.module.erp.controller.admin.sale.vo.out;
...
public class ErpSaleOutSaveReqVO {
    ...
    @I18nNotNull(i18nKey = "erp.saleOut.back.outTime.notNull", message = "出库时间不能为空")
    private LocalDateTime outTime;

    @Schema(description = "销售订单编号", requiredMode = Schema.RequiredMode.REQUIRED, example = "17386")
    @I18nNotNull(i18nKey = "erp.saleOut.back.orderId.notNull", message = "销售订单编号不能为空")
    ...
    public static class Item {
        ...
        @I18nNotNull(i18nKey = "erp.saleOutItem.back.orderItemId.notNull", message = "销售订单项编号不能为空")
        private Long orderItemId;

        @Schema(description = "仓库编号", requiredMode = Schema.RequiredMode.REQUIRED, example = "3113")
        @I18nNotNull(i18nKey = "erp.saleOutItem.back.warehouseId.notNull", message = "仓库编号不能为空")
        private Long warehouseId;

        @Schema(description = "产品编号", requiredMode = Schema.RequiredMode.REQUIRED, example = "3113")
        @I18nNotNull(i18nKey = "erp.saleOutItem.back.productId.notNull", message = "产品编号不能为空")
        private Long productId;

        @Schema(description = "产品单位单位", requiredMode = Schema.RequiredMode.REQUIRED, example = "3113")
        @I18nNotNull(i18nKey = "erp.saleOutItem.back.productUnitId.notNull", message = "产品单位单位不能为空")
