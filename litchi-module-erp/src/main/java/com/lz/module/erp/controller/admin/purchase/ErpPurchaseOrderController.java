package com.lz.module.erp.controller.admin.purchase;
...
import com.lz.module.erp.controller.admin.product.vo.product.ErpProductRespVO;
import com.lz.module.erp.controller.admin.purchase.vo.order.ErpPurchaseOrderPageReqVO;
import com.lz.module.erp.controller.admin.purchase.vo.order.ErpPurchaseOrderRespVO;
import com.lz.module.erp.controller.admin.purchase.vo.order.ErpPurchaseOrderSaveReqVO;
import com.lz.module.erp.dal.dataobject.purchase.ErpPurchaseOrderDO;
import com.lz.module.erp.dal.dataobject.purchase.ErpPurchaseOrderItemDO;
import com.lz.module.erp.dal.dataobject.purchase.ErpSupplierDO;
import com.lz.module.erp.service.product.ErpProductService;
import com.lz.module.erp.service.purchase.ErpPurchaseOrderService;
import com.lz.module.erp.service.purchase.ErpSupplierService;
import com.lz.module.erp.service.stock.ErpStockService;
    ...
    public CommonResult<ErpPurchaseOrderRespVO> getPurchaseOrder(@RequestParam("id") Long id) {
        ...
        return success(BeanUtils.toBean(purchaseOrder, ErpPurchaseOrderRespVO.class, purchaseOrderVO ->
                purchaseOrderVO.setItems(BeanUtils.toBean(purchaseOrderItemList, ErpPurchaseOrderRespVO.Item.class, item -> {
                    BigDecimal purchaseCount = stockService.getStockCount(item.getProductId(), null);
