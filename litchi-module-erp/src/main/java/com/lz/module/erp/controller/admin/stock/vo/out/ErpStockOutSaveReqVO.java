...
public class ErpStockOutSaveReqVO {
    ...
    @I18nNotNull(i18nKey = "erp.stockOut.back.outTime.notNull", message = "出库时间不能为空")
    ...
    @I18nNotEmpty(i18nKey = "erp.stockOut.back.items.notEmpty", message = "出库项列表不能为空")
    @Valid
    ...
    public static class Item {
        ...
        @I18nNotNull(i18nKey = "erp.stockOutItem.back.warehouseId.notNull", message = "仓库编号不能为空")
        private Long warehouseId;

        @Schema(description = "产品编号", requiredMode = Schema.RequiredMode.REQUIRED, example = "3113")
        @I18nNotNull(i18nKey = "erp.stockOutItem.back.productId.notNull", message = "产品编号不能为空")
        ...
        @I18nNotNull(i18nKey = "erp.stockOutItem.back.count.notNull", message = "产品数量不能为空")
