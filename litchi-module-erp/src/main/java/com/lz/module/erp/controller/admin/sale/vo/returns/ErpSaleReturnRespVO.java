package com.lz.module.erp.controller.admin.sale.vo.returns;
...
public class ErpSaleReturnRespVO {
    ...
    @ExcelProperty("退货时间")
    @ExcelI18n(i18nKey = "erp.saleReturn.field.returnTime")
    ...
    @ExcelProperty("附件地址")
    @ExcelI18n(i18nKey = "erp.saleReturn.field.fileUrl")
    private String fileUrl;

    @Schema(description = "备注", example = "你猜")
    @ExcelProperty("备注")
    @ExcelI18n(i18nKey = "erp.saleReturn.field.remark")
    private String remark;

    @Schema(description = "创建人", example = "荔枝")
    private String creator;
    @Schema(description = "创建人名称", example = "荔枝")
    private String creatorName;

    @Schema(description = "创建时间", requiredMode = Schema.RequiredMode.REQUIRED)
    @ExcelProperty("创建时间")
    @ExcelI18n(i18nKey = "erp.saleReturn.field.createTime")
    ...
    @ExcelProperty("产品信息")
    @ExcelI18n(i18nKey = "erp.saleReturn.field.productNames")
    ...
    public static class Item {
        ...
        @I18nNotNull(i18nKey = "erp.saleReturnItem.back.count.notNull", message = "产品数量不能为空")
