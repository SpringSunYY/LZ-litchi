...
public class ErpPurchaseReturnRespVO {
    ...
    @ExcelProperty("合计数量")
    @ExcelI18n(i18nKey = "erp.purchaseReturn.field.totalCount")
    private BigDecimal totalCount;
    @Schema(description = "最终合计价格", requiredMode = Schema.RequiredMode.REQUIRED, example = "24906")
    @ExcelProperty("最终合计价格")
    @ExcelI18n(i18nKey = "erp.purchaseReturn.field.totalPrice")
    ...
    @ExcelProperty("附件地址")
    @ExcelI18n(i18nKey = "erp.purchaseReturn.field.fileUrl")
    private String fileUrl;

    @Schema(description = "备注", example = "你猜")
    @ExcelProperty("备注")
    @ExcelI18n(i18nKey = "erp.purchaseReturn.field.remark")
    ...
    @ExcelProperty("创建时间")
    @ExcelI18n(i18nKey = "erp.purchaseReturn.field.createTime")
    ...
    @ExcelProperty("产品信息")
    @ExcelI18n(i18nKey = "erp.purchaseReturn.field.productNames")
