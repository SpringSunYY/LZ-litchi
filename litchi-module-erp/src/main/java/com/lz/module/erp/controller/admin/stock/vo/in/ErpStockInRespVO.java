...
public class ErpStockInRespVO {
    ...
    @ExcelProperty("创建时间")
    @ExcelI18n(i18nKey = "erp.stockIn.field.createTime")
    ...
    @ExcelProperty("产品信息")
    @ExcelI18n(i18nKey = "erp.stockIn.field.productNames")
