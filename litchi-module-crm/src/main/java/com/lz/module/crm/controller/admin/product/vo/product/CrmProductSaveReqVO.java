...
import com.lz.module.crm.framework.operatelog.core.CrmProductStatusParseFunction;
import com.lz.module.crm.framework.operatelog.core.CrmProductUnitParseFunction;
...
public class CrmProductSaveReqVO {
    ...
    @I18nNotNull(i18nKey = "crm.product.back.name.notNull", message = "产品名称不能为空")
    @DiffLogField(name = "产品名称")
    private String name;

    @Schema(description = "产品编码", requiredMode = Schema.RequiredMode.REQUIRED, example = "12306")
    @I18nNotNull(i18nKey = "crm.product.back.no.notNull", message = "产品编码不能为空")
    ...
    @I18nNotNull(i18nKey = "crm.product.back.price.notNull", message = "价格不能为空")
    @DiffLogField(name = "价格")
    private BigDecimal price;

    @Schema(description = "状态", requiredMode = Schema.RequiredMode.REQUIRED, example = "上架")
    @I18nNotNull(i18nKey = "crm.product.back.status.notNull", message = "状态不能为空")
    ...
    @I18nNotNull(i18nKey = "crm.product.back.categoryId.notNull", message = "产品分类编号不能为空")
    ...
    @I18nNotNull(i18nKey = "crm.product.back.ownerUserId.notNull", message = "负责人的用户编号不能为空")
