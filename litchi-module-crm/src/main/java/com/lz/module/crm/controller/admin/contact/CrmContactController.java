package com.lz.module.crm.controller.admin.contact;
...
import com.lz.module.crm.controller.admin.contact.vo.*;
    ...
    private List<CrmContactRespVO> buildContactDetailList(List<CrmContactDO> contactList) {
        ...
        return BeanUtils.toBean(contactList, CrmContactRespVO.class, contactVO -> {
            if (contactVO.getAreaCode() != null){
                contactVO.setAreaName(AreaUtils.format(contactVO.getAreaCode()));
            }
            // 2.1 设置客户名称
