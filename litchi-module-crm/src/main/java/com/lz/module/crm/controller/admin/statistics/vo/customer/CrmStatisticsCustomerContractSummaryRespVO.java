package com.lz.module.crm.controller.admin.statistics.vo.customer;
...
public class CrmStatisticsCustomerContractSummaryRespVO {
    ...
    @Schema(description = "客户名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "荔枝源码")
    ...
    @Schema(description = "负责人", requiredMode = Schema.RequiredMode.REQUIRED, example = "荔枝源码")
