package com.lz.module.ai.service.chat;
...
import com.lz.module.ai.controller.admin.chat.vo.message.AiChatMessagePageReqVO;
import com.lz.module.ai.controller.admin.chat.vo.message.AiChatMessageRespVO;
import com.lz.module.ai.controller.admin.chat.vo.message.AiChatMessageSendReqVO;
import com.lz.module.ai.controller.admin.chat.vo.message.AiChatMessageSendRespVO;
import com.lz.module.ai.dal.dataobject.chat.AiChatConversationDO;
import com.lz.module.ai.dal.dataobject.chat.AiChatMessageDO;
...
import com.lz.module.ai.dal.dataobject.model.AiToolDO;
import com.lz.module.ai.dal.mysql.chat.AiChatMessageMapper;
import com.lz.module.ai.enums.ErrorCodeConstants;
import com.lz.module.ai.enums.model.AiPlatformEnum;
import com.lz.module.ai.framework.ai.core.webserch.AiWebSearchClient;
import com.lz.module.ai.framework.ai.core.webserch.AiWebSearchRequest;
import com.lz.module.ai.framework.ai.core.webserch.AiWebSearchResponse;
import com.lz.module.ai.service.knowledge.AiKnowledgeDocumentService;
import com.lz.module.ai.service.knowledge.AiKnowledgeSegmentService;
...
import com.lz.module.ai.service.model.AiChatRoleService;
import com.lz.module.ai.service.model.AiModelService;
import com.lz.module.ai.service.model.AiToolService;
import com.lz.module.ai.util.AiUtils;
...
import static com.lz.framework.common.pojo.CommonResult.error;
...
import static com.lz.module.ai.enums.ErrorCodeConstants.CHAT_CONVERSATION_NOT_EXISTS;
import static com.lz.module.ai.enums.ErrorCodeConstants.CHAT_MESSAGE_NOT_EXIST;
...
public class AiChatMessageServiceImpl implements AiChatMessageService {
    ...
    @Autowired(required = false) // 由于 litchi.ai.web-search.enable 配置项，可以关闭 AiWebSearchClient 的功能，所以这里只能不强制注入
    private AiWebSearchClient webSearchClient;

    @SuppressWarnings("SpringJavaAutowiredFieldsWarningInspection")
    @Autowired(required = false) // 由于 litchi.ai.mcp.client.enable 配置项，可以关闭 McpSyncClient 的功能，所以这里只能不强制注入
    ...
    private void processFile(AiChatMessageSendReqVO sendReqVO, Long userId) {
        if (CollUtil.isEmpty(sendReqVO.getAttachmentUrls())) {
            return;
        }
        ArrayList<String> filePaths = new ArrayList<>();
        for (String attachmentUrl : sendReqVO.getAttachmentUrls()) {
            String filePath = fileApi.getFilePath(attachmentUrl);
            filePaths.add(filePath);
        }
        sendReqVO.setAttachmentUrls(filePaths);
    }
