package com.lz.module.mp.service.account;
...
import com.lz.module.mp.controller.admin.account.vo.MpAccountCreateReqVO;
import com.lz.module.mp.controller.admin.account.vo.MpAccountPageReqVO;
import com.lz.module.mp.controller.admin.account.vo.MpAccountUpdateReqVO;
import com.lz.module.mp.convert.account.MpAccountConvert;
import com.lz.module.mp.dal.dataobject.account.MpAccountDO;
import com.lz.module.mp.dal.mysql.account.MpAccountMapper;
import com.lz.module.mp.enums.ErrorCodeConstants;
...
import static com.lz.module.system.enums.ErrorCodeConstants.USER_USERNAME_EXISTS;
    ...
    public void initLocalCache() {
        ...
        TenantUtils.executeIgnore(() -> {
            ...
            try {
                ...
                log.error("[微信公众号 litchi-module-mp - 表结构未导入][参考 https://doc.iocoder.cn/mp/build/ 开启]");
            }
