package com.lz.module.infra.dal.dataobject.logger;

import com.lz.framework.common.enums.UserTypeEnum;
import com.lz.framework.mybatis.core.dataobject.BaseDO;
import com.lz.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
public class ApiErrorLogDO extends BaseDO {
     ...
     * 处理用户编号
     *
     * 关联 com.lz.adminserver.modules.system.dal.dataobject.user.SysUserDO.SysUserDO#getId()
     */
