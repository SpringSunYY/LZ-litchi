package com.lz.module.infra.controller.admin.codegen;
...
import com.lz.module.infra.controller.admin.codegen.vo.CodegenDetailRespVO;
import com.lz.module.infra.controller.admin.codegen.vo.CodegenPreviewRespVO;
...
import com.lz.module.infra.controller.admin.codegen.vo.table.CodegenTableRespVO;
...
import com.lz.module.infra.service.codegen.CodegenService;
...
public class CodegenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "name", description = "表名，模糊匹配", example = "litchi"),
            @Parameter(name = "comment", description = "描述，模糊匹配", example = "荔枝")
    })
