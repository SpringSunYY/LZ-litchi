...
import com.lz.module.infra.framework.file.core.client.local.LocalFileClient;
import com.lz.module.infra.framework.file.core.client.local.LocalFileClientConfig;
...
public class FileConfigServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetFileConfigPage() {
        // mock 数据
        FileConfigDO dbFileConfig = randomFileConfigDO().setName("荔枝源码")
