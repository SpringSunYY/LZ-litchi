package com.lz.module.infra.framework.file.core.s3;

import cn.hutool.core.io.resource.ResourceUtil;
import cn.hutool.core.util.IdUtil;
import com.lz.framework.common.util.validation.ValidationUtils;
import com.lz.module.infra.framework.file.core.client.s3.S3FileClient;
...
//        config.setAccessSecret(System.getenv("QINIU_SECRET_KEY"));
        ...
        config.setBucket("litchi");
        config.setDomain("http://test.litchi.iocoder.cn"); // 如果有自定义域名，则可以设置。http://static.litchi.iocoder.cn
        // 默认上海的 endpoint
